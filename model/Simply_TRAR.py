...
class Simply_TRAR(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        super(Simply_TRAR, self).__init__()
...
def build_Simply_TRAR(opt,requirements):
    ...
    return Simply_TRAR(bertl_text,vit,opt)