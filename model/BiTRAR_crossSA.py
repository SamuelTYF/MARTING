...
class BiTRAR_crossSA(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        super(BiTRAR_crossSA, self).__init__()
        ...
        self.trar = model.TRAR.BiTRAR_crossSA_model(opt)
...
def build_BiTRAR_crossSA(opt,requirements):
    ...
    return BiTRAR_crossSA(bertl_text,vit,opt)