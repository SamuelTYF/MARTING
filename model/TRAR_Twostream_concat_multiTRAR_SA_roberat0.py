  ...
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        ...
        self.classifier = torch.nn.Sequential(
            ...
            torch.nn.Linear(opt["output_size"]*3,2)
        )
    ...
    def forward(self, input):
        ...
        proj_feat = torch.concat((out1, bert_text[:, 0, :], out2), 1)
...
def build_TRAR_Twostream_concat_multiTRAR_SA_roberat0(opt,requirements):
