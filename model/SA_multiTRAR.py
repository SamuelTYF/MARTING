...
class SA_multiTRAR(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        super(SA_multiTRAR, self).__init__()
        ...
        self.trar = model.TRAR.SA_multiTRAR_model(opt)
...
def build_SA_multiTRAR(opt,requirements):
    ...
    return SA_multiTRAR(bertl_text,vit,opt)