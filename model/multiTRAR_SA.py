...
class multiTRAR_SA(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        super(multiTRAR_SA, self).__init__()
...
def build_multiTRAR_SA(opt,requirements):
    ...
    return multiTRAR_SA(bertl_text,vit,opt)

def build_multiTRAR_SA_bert(opt,requirements):
