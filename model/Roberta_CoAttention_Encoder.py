...
class Roberta_CoAttention_Encoder(torch.nn.Module):
    def __init__(self,bertl_text,bertl_attribute, opt):
        super(Roberta_CoAttention_Encoder, self).__init__()
...
def build_Roberta_CoAttention_Encoder(opt,requirements):
    ...
    return Roberta_CoAttention_Encoder(bertl_text,bertl_attribute,opt)