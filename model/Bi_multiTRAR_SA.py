...
class Bi_multiTRAR_SA(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        super(Bi_multiTRAR_SA, self).__init__()
        ...
        self.trar = model.TRAR.Bi_multiTRAR_SA_model(opt)
...
def build_Bi_multiTRAR_SA(opt,requirements):
    ...
    return Bi_multiTRAR_SA(bertl_text,vit,opt)