...
class Roberta_CoAttention_Vit(torch.nn.Module):
    def __init__(self,bertl_text,bertl_attribute,vit, opt):
        super(Roberta_CoAttention_Vit, self).__init__()
...
def build_Roberta_CoAttention_Vit(opt,requirements):
    ...
    return Roberta_CoAttention_Vit(bertl_text,bertl_attribute,vit,opt)