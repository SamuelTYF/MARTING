...
class Encoder_TRAR_Decoder_multiTRAR_SA(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,vit, opt):
        ...
        self.trar = model.TRAR.Encoder_TRAR_Decoder_multiTRAR_SA(opt)
...
def build_Encoder_TRAR_Decoder_multiTRAR_SA(opt,requirements):
    ...
    return Encoder_TRAR_Decoder_multiTRAR_SA(bertl_text,vit,opt)