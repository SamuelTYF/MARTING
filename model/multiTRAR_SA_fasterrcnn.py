...
class multiTRAR_SA_fasterrcnn(torch.nn.Module):
  # define model elements
    def __init__(self,bertl_text,fasterrcnn, opt):
        super(multiTRAR_SA_fasterrcnn, self).__init__()
...
def build_multiTRAR_SA_fasterrcnn(opt,requirements):
    ...
    return multiTRAR_SA_fasterrcnn(bertl_text,fasterrcnn,opt)